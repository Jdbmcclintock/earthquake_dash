...
def dashboard(n):
    ...
    try:
        ...
        latest_quake_location, latest_quake_magnitude = "ERROR", "ERROR"
    ...
    return dbc.Container(
        [   dbc.Row(
            ...
            dbc.Col(
                html.H1("NGMC Earthquake Dashboard", style={"fontSize":75, "textAlign":"center"}),
            ...
            dbc.Col([
                dbc.Row(
                    dbc.Col([
                        ...
                        html.P("last run: " + pendulum.now('Pacific/Auckland').to_datetime_string(),
                               style={"fontSize": 15, 'textAlign': 'left', 'marginTop':50})
    ],
                        style={"height  ":"100%"}),
                style = {"height" : "100%"}
                ),
